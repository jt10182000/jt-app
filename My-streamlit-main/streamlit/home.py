...
# Function to show the pages and sections
def show_portfolio():
    add_page_title()
    show_pages(
        [
...
# Overview content for the introduction section
st.markdown("""
##### 👨‍🔧 More Content
...
# Image related to machine learning
st.image("./ml.jpg")

# Detailed explanation of machine learning
st.markdown("""
